 ...
 * Carrega dados de assets/content/projects/data.json
 */
...
// Carrega dados dos projetos do arquivo centralizado
function loadProjectsData() {
    loadJSON('../assets/content/projects/data.json')
        .then(data => {
        ...
        .catch(error => console.error('Erro carregando projetos:', error));
